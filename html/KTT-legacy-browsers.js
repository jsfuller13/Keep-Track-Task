...
function Practice_Intro_2RoutineBegin(trials) {
  return function () {
    ...
    Practice_Intro_2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function Ans_CueRoutineBegin(trials) {
  return function () {
    ...
    Ans_CueComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function Intro_to_Full_TaskRoutineBegin(trials) {
  return function () {
    ...
    Intro_to_Full_TaskComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function Ready_MessageRoutineBegin(trials) {
  return function () {
    ...
    Ready_MessageComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
